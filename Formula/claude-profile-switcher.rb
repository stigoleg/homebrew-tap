...
# stigole/homebrew-tap as Casks/claude-profile-switcher.rb. After that, the
...
cask "claude-profile-switcher" do
  ...
  url "https://github.com/stigole/claude-account-switch/releases/download/v#{version}/ClaudeProfileSwitcher-#{version}.zip"
  name "Claude Profile Switcher"
  desc "Menu-bar app for switching between multiple Claude accounts (Desktop + CLI)"
  homepage "https://github.com/stigole/claude-account-switch"
